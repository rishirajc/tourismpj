...
<h3 style={{backgroundColor:"lightgreen"}}>Yogiatiripppads</h3>
...
<h3 style={{backgroundColor:"lightgreen"}}>Adi Shankara</h3>
...
<h3 style={{backgroundColor:"lightgreen"}}>Invasion of Tipu Sulta</h3>
<p>During the invasion of Tipu Sultan, the temple was not attacked by Tipu's Army.[15] Even though Tipu Sultan destroyed many temples in Thrissur district at that time, he never touched Vadakkumnathan Temple. According to historical accounts, when Tipu Sultan was marching towards the Travancore lines, known locally as Nedumkotta, he had a short stay at Thrissur city from 14 to 29 December 1789. In order to feed his Army, he had borrowed cooking vessels from Vadakkumnathan Temple. Before leaving Thrissur city, he not only returned the vessels, but presented the temple with a large bronze lamp.[</p>
<h3 style={{backgroundColor:"lightgreen"}}>Zamorin of Calicut</h3>
<p>During 1750 to 1762, the temple affairs were conducted by Zamorin of Calicut who attacked Thrissur and took control of the temple and the city. In 1762 with the help of Kingdom of Travancore, Maharaja of Cochin regained control over Thrissur and the temple.</p>
<h3 style={{backgroundColor:"lightgreen"}}>Sakthan Thampuran</h3>
<p>When Sakthan Thampuran, ascended the throne of Kingdom of Cochin, he changed the capital of Kingdom of Cochin from Thripunithura to Thrissur as the King had a personal relationship with Vadakkumnathan Temple. He later cleared the teak forest around the temple and introduced the famous Thrissur Pooram festival. The King's personal interest in the temple also changed the fortune of the city.</p>
<h3 style={{backgroundColor:"lightgreen"}}>Architecture</h3>
<p>The temple is situated on an elevated hillock in the centre of Thrissur City and is surrounded by a stone wall enclosing an area of nearly 9 acres (36,000 m2). Inside this fortification, there are four gopurams facing four cardinal directions. Between the inner temple and the outer walls, there is a spacious compound, the entrance to which is through gopurams. Of these, the gopurams on the south and north are not open to the public. The public enter either through the east or west gopuram. The inner temple is separated from the outer temple by a broad circular granite wall enclosing a broad corridor called Chuttambalam. Entrance into the inner temple is through a passage through the corridor.</p>
<h3 style={{backgroundColor:"lightgreen"}}>Deities</h3>
...
<h2 style={{backgroundColor:"lightgreen"}}>Festivals</h2>
<p>
  <h3 style={{backgroundColor:"lightgreen"}}>Maha Shivaratri</h3>
...
<h3 style={{backgroundColor:"lightgreen"}}>Aanayoottu </h3>
...
<h3 style={{backgroundColor:"lightgreen"}}>Thrissur Pooram </h3>
...
<img width={"200px"} height={"200px"} src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSN28zkl9qSG-4fugCbK3WBp3xzEcUhEcmxvQ&s" alt="" />
<img width={"200px"} height={"200px"} src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRZZF-7dvhKk8AIRcg7CtmU7FVvGVhN_fuC4Q&s" alt="" />
...
<img width={"200px"} height={"200px"} src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQWJrW8wkH4jsVJY5XVdw1TDutTuJb_cSqq6g&s" alt="" />
<img width={"200px"} height={"200px"} src="https://resize.indiatvnews.com/en/resize/newbucket/360_-/2019/05/elephant-1557386029.jpg" alt="" />
<img width={"200px"} height={"200px"} src="https://images.deccanherald.com/deccanherald/2024-04/65575ceb-6ac0-4418-bbeb-4be841295b38/file7v2h8yw8dqc74vdc1dr.jpg?w=1200&h=675&auto=format%2Ccompress&fit=max&enlarge=true" alt="" />
<img width={"200px"} height={"200px"} src="https://i.ytimg.com/vi/m5FIoHoETpo/mqdefault.jpg" alt="" />
...
export default Thrissurvadakkum
