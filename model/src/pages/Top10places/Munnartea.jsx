...
The former Kunda Valley Railway in Munnar was destroyed by a flood in 1924, but tourism officials are considering reconstructing the railway line</p>
<h2 style={{backgroundColor:"lightgreen"}}>Transportation</h2>
<p> <h3 style={{backgroundColor:"lightgreen"}}>Road</h3>
...
<h3 style={{backgroundColor:"lightgreen"}}>Railway </h3>
...
<h3 style={{backgroundColor:"lightgreen"}}>Airport </h3>
The nearest airport is Cochin International Airport, which is 110 kilometres (68 mi) away. The Coimbatore and Madurai airports are 165 kilometres (103 mi) from Munnar.</p>
<h3 style={{backgroundColor:"lightgreen"}}>Demographics</h3>
<p>According to the 2011 Census, Munnar Grama Panchayat had a total population of 32,039. 16,061 were males and 15,968 were females, with 7,968 families total residing therein. Children represented in the age group of 0-6 were 2,916 (9.1% of the total population), which constitutes 1,478 males and 1,438 females. Munnar Panchayat had an overall literacy rate of 84.85%, substantially lower than the Kerala state average of 94.00%. Male literacy stands at 91.05% and female literacy at 78.64%.</p>
<h3 style={{backgroundColor:"lightgreen"}}>Endemic species</h3>
<p>These protected areas are especially known for several threatened and endemic species including Nilgiri Thar, the grizzled giant squirrel, the Nilgiri wood-pigeon, elephant, the gaur, the Nilgiri langur, the sambar, and the Neelakurinji (that blossoms only once in twelve years)</p>
<h3 style={{backgroundColor:"lightgreen"}}>Land ownership</h3>
<p>There has been action to address the problems of property takeovers by the land mafia that have, according to successive governments, plagued the area. In 2011, the government estimated that 20,000 hectares of land had been illegally appropriated and launched a campaign of evictions that had first been mooted in 2007</p>
...
<img width={"200px"} height={"200px"} src="https://static.toiimg.com/thumb/msid-85515152,width-748,height-499,resizemode=4,imgsize-344180/.jpg" alt="" />
<img width={"200px"} height={"200px"} src="https://m.media-amazon.com/images/I/61Jcg-VpHML._UF1000,1000_QL80_.jpg" alt="" />
<img width={"200px"} height={"200px"} src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQQXz23dMHRCsXvPyM8Z5qv6P2dCDL_NxiGbA&s" alt="" />
...
<img width={"200px"} height={"200px"} src="https://content.r9cdn.net/rimg/dimg/a9/dd/d6b29241-city-44818-166a7453734.jpg?width=1200&height=630&xhint=1600&yhint=1049&crop=true" alt="" />
<img width={"200px"} height={"200px"} src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQ3q_9AwpLgPv63s0pbEhUKdtXkzcV7yzkhLQ&s" alt="" />
<img width={"200px"} height={"200px"} src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcS1rioiVABWfFw--oPikR1evwVf3-BDf3zYgAP4KOEhMeLiaRHP6DnzWWRBhBCJnt-WAcI&usqp=CAU" alt="" />
<img width={"200px"} height={"200px"} src="https://www.blanketmunnar.com/images/munnar-sightseeing-banner-mob.jpg" alt="" />
