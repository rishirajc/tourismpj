...
const Kasaragod = () => {
  return (
    <div>
      <div>
        <img width={"100%"} src="https://blogger.googleusercontent.com/img/b/R29vZ2xl/AVvXsEiIQeKNESbYYWVf522bhCkmD1gDu58ahbzfd96gjMP-Mx159bGC-9eSZLKV1y-ddAd77IVVf8L1AEa7BmxszS2y308uAaOE3Z1JhcNnMCLdq1Kf7qJuf78_Pncrb10imPlxTJAlfTPJJFdh/s1600/IMG_20150404_152455_1428143169475.jpg" alt="" />
      </div>
      <h1>ABOUT KASARAGOD</h1>
...
<IMG>
  ...
  <img  height={"450px"} width={"400px"}style={{marginTop:"80px"}} src="https://decodemalayalam.com/wp-content/uploads/2024/05/Add-a-subheading.jpg" alt="" />
   <img  height={"450px"} width={"400px"}style={{marginTop:"80px"}} src="https://static.toiimg.com/photo/53095543.cms" alt="" />
<img  height={"450px"} width={"400px"}style={{marginTop:"80px"}} src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTs0m0tQ3tc2RmyWqBKm_J3fjcE4ZVXblKR0g&s" alt="" />
 <img  height={"450px"} width={"400px"}style={{marginTop:"80px"}} src="https://i.ytimg.com/vi/IG2U0Umqbk0/maxresdefault.jpg" alt="" />
 <img  height={"450px"} width={"400px"}style={{marginTop:"80px"}} src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQZ5c3cRXKBS3koqe6KILCuLZJ9sblJjX7JcA&s" alt="" />
 <img height={"450px"} width={"400px"}style={{marginTop:"80px"}}  src="https://i.ytimg.com/vi/C_4LuIQcVos/maxresdefault.jpg" alt="" />
 </IMG>
 <div style={{height:'300px',paddingLeft:'500px',paddingTop:'100px'}}>
  <h2>constact us for more information</h2>
  <h2>keralatourism@gmail.com</h2>
 </div>
