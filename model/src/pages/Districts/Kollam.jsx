...
import img13 from '../images/kollam-1735300390320.png'
...
const Kollam = () => {
  ...
  return (
    <div>
     ...
     <h1  style={{marginLeft:"38%",paddingTop:"5px",fontFamily:'math'}}>ABOUT KOLLAM</h1>
...
<p>As the ancient city of Quilon, Kollam was a flourishing port during the Pandya dynasty (c. 3rd century BC–12th century), and later became the capital of the independent Venad or the Kingdom of Quilon on its foundation in c. 825. Kollam was considered one of the four early entrepots in global sea trade during the 13th century, along with Alexandria and Cairo in Egypt, the Chinese city of Quanzhou, and Malacca in the Malaysian archipelago.[29] It seems that trade at Kollam seems to have flourished right into the Medieval period as in 1280, there is instance of envoys of Yuan China coming to Kollam for establishing relations between the local ruler and China.[30]

Pandya rule
The ancient political and cultural history of Kollam was almost entirely independent from that of the rest of Kerala. The Chera dynasty governed the area of Malabar Coast between Alappuzha in the south to Kasaragod in the north. This included Palakkad Gap, Coimbatore, Salem, and Kolli Hills. The region around Coimbatore was ruled by the Cheras during Sangam period between c. first and the fourth centuries CE and it served as the eastern entrance to the Palakkad Gap, the principal trade route between the Malabar Coast and Tamil Nadu.[31] However the southern region of present-day Kerala state (The coastal belt between Thiruvananthapuram and Alappuzha) was under Ay dynasty, who was more related to the Pandya dynasty of Madurai than Cheras.[32]
...
Cosmas Indicopleustes, a Greek Nestorian sailor,[33] in his book the Christian Topography[34] who visited the Malabar Coast in 550, mentions an enclave of Christian believers in Male (Malabar Coast). He writes, "In the island of Tabropane (Ceylon), there is a church of Christians, and clerics and faithful. Likewise at Male, where the pepper grows, and in the farming community of Kalliana (Kalliankal at Nillackal) there is also a bishop consecrated in Persia in accordance with the Nicea Sunnahadose of 325 AD."[35] The Nestorian Patriarch Jesujabus, who died in 660 AD, mentions Kollam in his letter to Simon, Metropolitan of Persia.

Kollam is also home to one of the oldest mosques in Indian subcontinent. According to the Legend of Cheraman Perumals, the first Indian mosque was built in 624 AD at Kodungallur with the mandate of the last the ruler (the Cheraman Perumal) of Chera dynasty, who left from Dharmadom to Mecca and converted to Islam during the lifetime of Muhammad (c. 570–632).[36][37][38][39] According to Qissat Shakarwati Farmad, the Masjids at Kodungallur, Kollam, Madayi, Barkur, Mangalore, Kasaragod, Kannur, Dharmadam, Panthalayini, and Chaliyam, were built during the era of Malik Dinar, and they are among the oldest Masjids in Indian subcontinent.[40] It is believed that Malik Dinar died at Thalangara in Kasaragod town</p>
<h4  style={{marginLeft:"37%",paddingTop:"5px",fontFamily:'math'}}>Capital of Venad (9th to 12th centuries)</h4>
<p>The port at Kollam, then known as Quilon, was founded in 825 by the Nestorian Christians Mar Sabor and Mar Proth with sanction from Ayyanadikal Thiruvadikal, the king of the independent Venad or the State of Quilon, a feudatory under the Chera kingdom.[42][43][44]

It is believed that Mar Sapor Iso also proposed that the Chera king create a new seaport near Kollam in lieu of his request that he rebuild the almost vanished inland seaport at Kollam (kore-ke-ni) near Backare (Thevalakara), also known as Nelcynda and Tyndis to the Romans and Greeks and as Thondi to the Tamils, which had been without trade for several centuries because the Cheras were overrun by the Pallavas in the sixth century, ending the spice trade from the Malabar coast. This allowed the Nestorians to stay in the Chera kingdom for several decades and introduce the Christian faith among the Nampoothiri Vaishnavites and Nair sub-castes in the St. Thomas tradition, with the Syrian liturgy as a basis for the Doctrine of the Trinity, without replacing the Sanskrit and Vedic prayers.[45] The Tharisapalli plates presented to Maruvan Sapor Iso by Ayyanadikal Thiruvadikal granted the Christians the privilege of overseeing foreign trade in the city as well as control over its weights and measures in a move designed to increase Quilon's trade and wealth.[44][46] The two Christians were also instrumental in founding Christian churches with Syrian liturgy along the Malabar coast, distinct from the ancient Vedic Advaitam propounded by Adi Shankara in the early ninth century among the Nampoothiri Vaishnavites and Nair Sub Castes, as Malayalam was not accepted as a liturgical language until the early 18th century.

Thus began the Malayalam Era, known as Kolla Varsham after the city, indicating the importance of Kollam in the ninth century.[44] The Persian merchant Soleyman of Siraf visited Malabar in the ninth century and found Quilon to be the only port in India used by the huge Chinese ships as their transshipment hub for goods on their way from China to the Persian Gulf. The rulers of Kollam (formerly called 'Desinganadu') had trade relations with China and exchanged embassies. According to the records of the Tang dynasty (618–913),[47] Quilon was their chief port of call before the seventh century. The Chinese trade decreased about 600 and was again revived in the 13th century. Mirabilia Descripta by Bishop Catalani gives a description of life in Kollam, which he saw as the Catholic bishop-designate to Kollam, the oldest Catholic diocese in India. He also gives[48] true and imaginary descriptions of life in 'India the Major' in the period before Marco Polo visited the city. Sulaiman al-Tajir, a Persian merchant who visited Kerala during the reign of Sthanu Ravi Varma (9th century CE), records that there was extensive trade between Kerala and China at that time, based at the port of Kollam.</p>
<h4  style={{marginLeft:"35%",paddingTop:"5px",fontFamily:'math'}}>Kollam as "Colombo" in the Catalan Atlas (1375)</h4>
<p>In the 13th century CE, Maravarman Kulasekara Pandyan I, a Pandya ruler fought a war in Venad and captured the city of Kollam.[54] The city appears on the Catalan Atlas of 1375 CE as Columbo and Colobo. The map marks this city as a Christian city, ruled by a Christian ruler.[50]

The text above the picture of the king says:

Açí seny[o]reja lo rey Colobo, christià. Pruvíncia de Columbo
(Here reigns the Lord King Colobo, Christian, Province of Columbo).[50]
...
Known as the "Cashew Capital of the World", Kollam is noted for its traditional cashew business and is home to more than 600 cashew-processing units. Every year, about 800,000 tonnes of raw cashews are imported into the city for processing[105] and an average of 130,000 tonnes of processed cashews are exported to various countries worldwide.[106] The Cashew Export Promotion Council of India (CEPCI) expects a rise in exports to 275,000 tonnes by 2020, an increase of 120 per cent over the current figure.[107] The Kerala State Cashew Development Corporation Limited (KSCDC) is situated at Mundakkal in Kollam city. The company owns 30 cashew factories all across Kerala. Of these, 24 are located in Kollam district.[108][109]

Kollam is one of many seafood export hubs in India with numerous companies involved in the sector. Most of these are based in the Maruthadi, Sakthikulangara, Kavanad, Neendakara, Asramam, Kilikollur, Thirumullavaram and Uliyakovil areas of the city.[110][111] Capithans, Kings Marine Exporters, India Food Exports and Oceanic Fisheries are examples of seafood exporters</p>
</div>
<h1  style={{paddingTop:"5px",fontFamily:'math',marginLeft:"45%",textDecoration:"underline"}}>ROUTE MAP</h1>
<img  style={{width:'500px',height:'400px',marginLeft:"36%",boxShadow:"1px 1px 20px rgb(202,189,189)"}}  src={img13} alt="" />


<div width={'100%'} height={'100px'} style={{marginLeft:"48%"}}>
<a href="https://maps.app.goo.gl/moen4NKsnVo8hvow9">click to open map</a>

</div>

 <h1  style={{marginLeft:"41%",paddingTop:"5px",fontFamily:'math',textDecoration:"underline"}}>MAJOR ATTRACTIONS</h1>
<IMG>
<Link to={'/parajadayu'}><img  height={"450px"} width={"400px"}style={{marginTop:"40px",borderRadius:'18px'}} src="https://upload.wikimedia.org/wikipedia/commons/thumb/6/6c/Jatayu_Earth_Centre.jpg/1280px-Jatayu_Earth_Centre.jpg" alt="" /></Link> 
   ...
   <Link to={'/sasthamkotta'}><img  height={"450px"} width={"400px"}style={{marginTop:"40px",borderRadius:'18px'}} src="https://i.ytimg.com/vi/1pT-nTMPID8/maxresdefault.jpg" alt="" /></Link> 
   <Link to={'/shendum'}> <img  height={"450px"} width={"400px"}style={{marginTop:"40px",borderRadius:'18px'}} src="https://i.ytimg.com/vi/Gfz5zkuX4rA/maxresdefault.jpg" alt="" /></Link> 
</IMG>
