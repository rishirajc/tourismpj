...
<h4  style={{backgroundColor:"lightgreen"}}>Capital of Venad (9th to 12th centuries)</h4>
...
<h4  style={{backgroundColor:"lightgreen"}}>Kollam as "Colombo" in the Catalan Atlas (1375)</h4>
...
<h4  style={{backgroundColor:"lightgreen"}}>Portuguese, Dutch and British Trade and Influences (16th to 18th centuries)</h4>
...
<p><h4  style={{backgroundColor:"lightgreen"}}>Battle of Quilon </h4>
...
The Battle of Quilon was fought in 1809 between a troop of the Indian kingdom of Travancore led by the then Dalawa (prime minister) of Travancore, Velu Thampi Dalawa and the British East India Company led by Colonel Chalmers at Cantonment Maidan in Quilon. The battle lasted for only six hours[63] and was the result of the East India Company's invasion of Quilon and their garrison situated near the Cantonment Maidan. The company forces won the battle while all the insurrectionist who participated in the war were court-martialed and subsequently hanged at the maidan.[64]
 ...
 <h4  style={{backgroundColor:"lightgreen"}}>Travancore Rule</h4>
...
Travancore became the most dominant state in Kerala by defeating the powerful Zamorin of Kozhikode in the battle of Purakkad in 1755.[66] The Government Secretariat was also situated in Kollam till the 1830s. It was moved to Thiruvananthapuram during the reign of Swathi Thirunal.[67]
 ...
 <h4  style={{backgroundColor:"lightgreen"}}>Excavation at Kollam Port seabed</h4>
...
<h4  style={{backgroundColor:"lightgreen"}}>Economy</h4>
...
<img  style={{width:'500px',height:'400px'}}  src={img13} alt="" />
</div>
