...
<h4>The Kutumbiyas (Kudumbiyas) </h4>

 <h4>Thamarassery Churam</h4>
...
<h4>he Western Chalukyas (Kalyani Chalukyas) </h4>
...
Karapuzha Dam is considered to be one of the biggest earth dams in India, which has been constructed on the Karapuzha River, a tributary of the Kabini River. Vazhavatta in Vythiri taluk of Wynad district for providing irrigation to an area of 5580 ha (CCA) say 5600 hectare in Vythiri and Sultan Bathery taluks of Wynad district of Kerala. The reservoir has a gross storage capacity of 76.50 M Cum and live storage capacity of 72.00 M Cum.[64]</p>
   ...
   <IMG>
<img height={"450px"} width={"400px"}style={{marginTop:"80px"}}   src="https://i.ytimg.com/vi/uUSySEqDytg/hq720.jpg?sqp=-oaymwEhCK4FEIIDSFryq4qpAxMIARUAAAAAGAElAADIQj0AgKJD&rs=AOn4CLA_5OYhMCJbVwtjkkYhu6myuL5Izg" alt="" />
  <img height={"450px"} width={"400px"}style={{marginTop:"80px"}}  src="https://i.ytimg.com/vi/_kvyMlbYJTQ/hq720.jpg?sqp=-oaymwEhCK4FEIIDSFryq4qpAxMIARUAAAAAGAElAADIQj0AgKJD&rs=AOn4CLCSfULFNuX3K-z9IRn2BPIQu1lwkQ" alt="" />
  <img height={"450px"} width={"400px"}style={{marginTop:"80px"}}  src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTJ02wrUc2ZnZ7Qbj5Zb53LiUeXM_FL7SjWhA&s" alt="" />
  <img height={"450px"} width={"400px"}style={{marginTop:"70px"}} src="https://i.ytimg.com/vi/-ZTiOkSE5gc/maxresdefault.jpg" alt="" />
  <img height={"450px"} width={"400px"}style={{marginTop:"70px"}}  src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRkFrHjiLxv-tU912er1TqjcVAOxH6vNeNFmg&s" alt="" />
   <img  height={"450px"} width={"400px"}style={{marginTop:"70px"}} src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTDuw-ZjD0hpRvEOTeNC5cwvM5HH6GQNA9KPQ&s" alt="" />
   </IMG>
   <LAST>
