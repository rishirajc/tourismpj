...
<h4>Raja Kesavadas and Alappuzha</h4>
...
<h4>Backwater paddy cultivation</h4>
...
Cochin International Airport, which is 78 kilometres (48 mi) to the North, is the closest airport. Thiruvananthapuram International Airport, 159 kilometres (99 mi) to the South, is the other airport that links the district with other countries. International tourists use these airports to reach Alappuzha. The other nearest airports are Calicut (236 kilometres (147 mi)) and Coimbatore (254 kilometres (158 mi)) airports. A helipad in the town is reserved for government uses.</p>
 ...
 <IMG>
<img  height={"450px"} width={"400px"}style={{marginTop:"40px"}} src="https://i.ytimg.com/vi/WRVRDzaQodg/sddefault.jpg" alt="" />
<img  height={"450px"} width={"400px"}style={{marginTop:"40px"}} src="https://i.ytimg.com/vi/DX5n2f5Vu9s/maxresdefault.jpg" alt="" />
<img  height={"450px"} width={"400px"}style={{marginTop:"40px"}} src="https://i.ytimg.com/vi/4I39M3F8bXk/maxresdefault.jpg" alt="" />
<img  height={"450px"} width={"400px"}style={{marginTop:"40px"}} src="https://i0.wp.com/planashleygo.com/wp-content/uploads/2024/05/Krishnapuram-Palace.jpg?fit=1024%2C577&ssl=1" alt="" />
<img  height={"450px"} width={"400px"}style={{marginTop:"40px"}} src="https://planashleygo.com/wp-content/uploads/2024/05/International-Coir-Museum.jpg" alt="" />
<img  height={"450px"} width={"400px"}style={{marginTop:"40px"}} src="https://planashleygo.com/wp-content/uploads/2024/05/Revi-Karunakaran-Memorial-Museum-cover.jpg" alt="" />
 </IMG>
