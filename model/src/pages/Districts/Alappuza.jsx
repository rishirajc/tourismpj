...
const Alappuza = () => {
  return (
    <div>
     ...
     <h1  style={{marginLeft:"40%",paddingTop:"5px",fontFamily:'math'}}>ABOUT ALAPUZA</h1>
...
The standard dialect of Malayalam spoken is Central Travancore dialect.[28] Konkani is a language that is spoken in the Konkan region. During the Portuguese and Dutch invasions of the 16th and 18th centuries, many Konkanis migrated southwards to Thuravoor, Cherthala and Alappuzha in the state of Travancore as well as other places in Kerala like Cochin, Kodungalloor, and Kollam. A majority of these people got settled in Alappuzha.</p>
<h4  style={{marginLeft:"46%",paddingTop:"5px",fontFamily:'math'}}>Economy</h4>
<p>The economy of the district is based on agriculture and marine products. The agricultural activities predominantly revolve around the Kuttanad region, the rice bowl of Kerala. Though the district is industrially backward, some traditional industries based on coir and coir products, marine products, handlooms, different types of handicrafts, toddy tapping have been active from the very early times. The district is known as the traditional home of coir industry in Kerala.[32]


Alappuzha has extensive backwaters used for transportation and tourism purposes too.
The availability of raw materials and the existence of backwaters and canals suitable for the getting of green husk and accessibility of transportation are the main factors of the development of this industry. Arabs had carried on trade in coir products from very ancient period. The manufacture of mats and mattings were first introduced in 1859 by James Durragh.[33]

The Coir Board was established by the Central Government under the provisions of the Coir Industry Act in 1955.[34] A coir research institute functions at Kalavoor.[35] The National Coir Training and Designing Centre was established at Alappuzha in 1965.

Coir is the most important commodity manufactured in Alappuzha, Kayamkulam, Kokkothamangalam, Komalapuram, Mannancherry, Muhamma and Vayalar.[36] Coir products are available in Cherthala and Mannancherry, lime shell in Arookutty and Kodamthuruth, plywood in Chengannur, Keltron controls in Aroor,[37] potassium chloride in Mavelikkara, and coconuts and coconut oil in Thanneermukkom. Other important commodities manufactured in these towns are copra, glass, mats and matches.[38]
...
State Highway 11
There are eight state highways in Alappuzha district, of which three of them originates from Alappuzha town. State Highway 11 starts from Kalarcode and ends at Perunna. This highway is locally known as AC road (Alappuzha-Changanassery road) and it covers a distance of 24.2 km. It is an important road which connects Alappuzha town with Kottayam district. Stateway High 40 is an interstate highway in Alappuzha district which connects Alappuzha town with Madurai in Tamil Nadu. It is the only interstate highway in Alappuzha district. State Highway 66 originates from Alappuzha town and terminates at Thoppumpady.[44]
...
<h4  style={{marginLeft:"47%",paddingTop:"5px",fontFamily:'math'}}>Water </h4>
...
<a href="https://maps.app.goo.gl/nMsPevt4xpDovjYNA">click to open map</a>
 ...
 <IMG>
<Link to={'/alappybch'}> <img   height={"450px"} width={"400px"}style={{marginTop:"40px",borderRadius:'18px'}} src="https://i.ytimg.com/vi/WRVRDzaQodg/sddefault.jpg" alt="" /></Link>
<Link to={'/houseboat'}><img  height={"450px"} width={"400px"}style={{marginTop:"40px",borderRadius:'18px'}}  src="https://i.ytimg.com/vi/DX5n2f5Vu9s/maxresdefault.jpg" alt="" /></Link>
<Link to={'/chetti'}><img  height={"450px"} width={"400px"}style={{marginTop:"40px",borderRadius:'18px'}}  src="https://i.ytimg.com/vi/4I39M3F8bXk/maxresdefault.jpg" alt="" /></Link>
<Link to={'/krishnapuram'}><img  height={"450px"} width={"400px"}style={{marginTop:"40px",borderRadius:'18px'}}  src="https://i0.wp.com/planashleygo.com/wp-content/uploads/2024/05/Krishnapuram-Palace.jpg?fit=1024%2C577&ssl=1" alt="" /></Link>
<Link to={'/koirmusem'}><img   height={"450px"} width={"400px"}style={{marginTop:"40px",borderRadius:'18px'}}  src="https://planashleygo.com/wp-content/uploads/2024/05/International-Coir-Museum.jpg" alt="" /></Link>
<Link to={'/revi'}><img  height={"450px"} width={"400px"}style={{marginTop:"40px",borderRadius:'18px'}}  src="https://planashleygo.com/wp-content/uploads/2024/05/Revi-Karunakaran-Memorial-Museum-cover.jpg" alt="" /></Link>
 </IMG>
