...
const Thrissur = () => {
  return (
    <div>
     ...
     <h1  style={{marginLeft:"38%",paddingTop:"5px",fontFamily:'math'}}>ABOUT THRISSUR</h1>
...
In 1947, when India gained independence from colonial rule, Thrissur was part of the Kingdom of Cochin. Thrissur district was formed on 1 July 1949, with the headquarters at the city of Thrissur.</p>
       
<h3  style={{marginLeft:"45%",paddingTop:"5px",fontFamily:'math'}}>Geography</h3>
<p>Thrissur is the headquarters of Thrissur district, in the center of the Indian state of Kerala. The city is 75 km north-east of Kochi, 133 km south-west of Coimbatore, 124 km south-east of Kozhikode and 151 km north of Changanacherry.[37] The city is located in a hillock called Thekkinkadu Maidan which is the second highest point in the city after the Vilangan Hills. The city has an average altitude of 2.83 meters above sea level.[37]

From the hillock, the city gradually flattens into the Thrissur-Ponnani Kole Wetlands, which act as natural drainage for the city. The water from the wetlands flows via rivers into the Laccadive Sea, keeping Thrissur city safe from the major flooding that affects most other cities in Kerala.[38][39][40][41]

The city is located in the midland region of Kerala, with an extended part of the Palakkad plains.[42] The city geologically is composed of Archaean gneisses and crystalline schists. Major parts of the city are covered by Archaean rocks.[43] The city lies near the center of the Indian tectonic plate (the Indian Plate) and is subject to comparatively little seismic or volcanic activity</p>

<h4  style={{marginLeft:"47%",paddingTop:"5px",fontFamily:'math'}}>Climate</h4>
<p>Under the Köppen climate classification, the City of Thrissur features a tropical monsoon climate (Am). Summer lasts from March to May which is the hottest time of the year. Summer months are uncomfortable due to higher levels of heat and humidity. Daytime temperatures can rise up to 36 to 38 °C (96.8 to 100.4 °F) coupled with excessive humidity. Summer is followed by the southwest monsoon from June to September. October and November form the post-monsoon or retreating monsoon season. Winter from December through February is cooler, and windy, due to winds from the Western Ghats. Winter months are generally dry and less humid compared to other months of the year. Morning temperatures are usually cool and daytime temperatures hover around 30 °C or 86 °F.[44]

The city is drenched in the monsoonal season by heavy showers. The average annual rainfall is approximately 3,100 millimetres or 122 inches. The South-west monsoon generally sets in during the last week of May. After July the rainfall decreases. On average, there are 124 rainy days in a year. The maximum average temperature of the city in the summer season is 36 °C or 96.8 °F while the minimum temperature recorded is 27 °C or 80.6 °F. The winter season records a maximum average of 31 °C or 87.8 °F and a minimum average of 20 °C or 68 °F.[44]</p>

 <h4  style={{marginLeft:"47%",paddingTop:"5px",fontFamily:'math'}}>Festivals</h4>
 <p>Thrissur is known as the Cultural Capital of Kerala, the city enjoys a thriving cultural tradition dating back to centuries. Thrissur Pooram, the largest pooram in Kerala, is sometimes referred to as 'the pooram of all poorams'. It is celebrated every year in the month of Medam (mid-April to mid-may) as per the Malayalam calendar. For thirty-six hours, the city plays host to a large gathering of people and elephants.[86][87][88][89]

Puli Kali, also known as Kavakali, is another festival, which attracts thousands of people to the city. It is performed by trained artists to entertain people on the occasion of Onam, an annual harvest festival, celebrated mainly in Kerala.[90][91] Buon Natale is the cultural festival conducting at Swaraj Round with Christmas celebration. Buon Natale procession entered the Guinness World Records in 2014 for having the maximum number of people dressed up as Santa Claus. Other important festivals celebrated in the city include Christmas, Onam, Diwali, Easter, Eid and Vishu.

Elephants play a major part in many of the city's festivals.[92][93] Aanayoottu (feeding of elephants), held in Vadakkunnathan Temple in the City annually, is the world's largest elephant feeding ceremony. The ceremony is conducted on the first day of the Malayalam month of Karkidakam.[94][95][96]</p>
   <h4  style={{marginLeft:"47%",paddingTop:"5px",fontFamily:'math'}}>Literature</h4>
   <p>Literary lineage of city dates back to early history of Kerala but it came to prominence after Kerala Government set up Kerala Lalita Kala Akademi, Kerala Sahitya Academy, Kerala Sangeetha Nadaka Academy and College of Fine Arts, Thrissur for promoting literature, music and arts in Kerala. After the Indian Independence, Thrissur became the literary capital of Kerala as turned to the playground of novelist, poets and orators. In 1952 when Current Books set its first shop in Thrissur by former education Minister Professor Joseph Mundassery, it become the abode of writer's like O. V. Vijayan, Kovilan, V. K. N., Uroob, Edasseri Govindan Nair, M. T. Vasudevan Nair, K. G. Sankara Pillai and Sarah Joseph. The area was later known as Current Moola ("Current Corner").[97] The building that housed the Current Books bookshop was demolished in 2011.[98]

Thrissur is home to prominent Malayalam literary figures like Kovilan, Kunhunni Mash, Sukumar Azhikode, K. Satchidanandan, Mullanezhi, Sarah Joseph, Attoor Ravi Varma, Lalitha Lenin, P. Bhaskaran, Joseph Mundassery.[</p>
   <h4  style={{marginLeft:"44%",paddingTop:"5px",fontFamily:'math'}}>Religious buildings</h4>
   <p>The Vadakkunnathan temple, believed to have been founded by the legendary saint Parasurama, is an example of the Kerala style of architecture and houses several sacred shrines and murals delineating graphically, various episodes from the Mahabharata. Thiruvambadi Sri Krishna Temple, one of the largest Sree Krishna temples in Kerala and Paramekkavu Bagavathi Temple which is one of the largest Bagavathi temples in Kerala is also situated in the city. Aykunnu Pandavagiri Devi Temple is situated at Venginisseri village, that around 9 km from city center. Sree Guruvayurappan Temple is located in Guruvayur (28 km from Thrissur); it is also referred to as Bhuloka Vaikunta which means "Holy Abode of Vishnu on Earth".
...
The Chettiyangadi Hanafi Mosque in Thrissur City is one of the oldest mosque in Thrissur. Cheraman Juma Mosque in Kodungallur, (40 km from Thrissur) is the first mosque in India.</p>
   
    <h4 style={{marginLeft:"47%",paddingTop:"5px",fontFamily:'math'}}>Education</h4>
    <p>Thrissur, which has been a centre of learning from ancient times, is developing as a modern education hub.[100][101] Schools in city are either run publicly by the Kerala Government or privately, some with financial aid from the Government. Education is generally conducted in English or Malayalam, with the former being the majority. Most schools are affiliated with the Kerala State Education Board or Indian Certificate of Secondary Education (ICSE) or the Central Board for Secondary Education (CBSE) or the National Institute of Open Schooling (NIOS) or the Montessori system.[102][103] There are 93 lower primary schools; 34 upper primary schools;[104][105] and 78 high schools;[106] and 157[107] higher secondary schools in the city. Church Mission Society School started in 1845 is the oldest school and St. Thomas College is the first college in Thrissur. On 2nd September 2022, Thrissur joined the UNESCO Global Network of Learning Cities </p>
    
    <p> <h4  style={{marginLeft:"49%",paddingTop:"5px",fontFamily:'math'}}>Road</h4>
The city is connected to the North-South Corridor National Highway (India) via the four-lane National Highway 544, previously NH 47.[133] The highway traverses through the entire length and breadth of the city from different points and provides access to the nearby cities such of Kochi, Palakkad and Coimbatore. NH 544 provides two main exit points at Mannuthy and Thalore which is bypass to the Thrissur city.

The city is largely dependent on private buses, taxis and auto rickshaws for public transport. A transit terminal was announced for Puzhakkal in 2013.[134] Land was transferred to the Thissur Mobility Hub Society on a 99-year lease in 2015.[135]
...
<a href="https://maps.app.goo.gl/kMkfhERghXSDNkx58">click to open map</a>
   ...
   <Link to={'/kala'}><img height={"450px"} width={"400px"}style={{marginTop:"40px",borderRadius:'18px'}}  src="https://live.staticflickr.com/2696/4371455435_e6e90c447f_b.jpg" alt="" /></Link>  
   <Link to={'/chavakkad'}><img height={"450px"} width={"400px"}style={{marginTop:"40px",borderRadius:'18px'}} src="https://i.ytimg.com/vi/XK8-LOAWxSc/sddefault.jpg" alt="" /></Link> 
   </IMG>
