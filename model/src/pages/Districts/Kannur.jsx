...
const Kannur = () => {
  ...
  return (
    ...
    <div  >
         ...
         <iframe width="100%" height="600px" src="https://www.youtube.com/embed/pCoK623T3ms?si=XMEKg41_wCksP48B" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>      </div>
         <div style={{backgroundColor:"#78a9d4",paddingTop:"86px"}}>
      <h1  style={{marginLeft:"37%",paddingTop:"5px",fontFamily:'math'}}>ABOUT KANNUR</h1>
...
Kannur Cantonment is the only cantonment board in Kerala.[11] The Indian Naval Academy at Ezhimala is Asia's largest, and the world's third-largest, naval academy.[12][non-primary source needed] Muzhappilangad beach is the longest drive-in beach in Asia and appeared among the top six best beaches for driving in the world in a BBC Top Gear article.[13] During British rule, Kannur's chief importance laid in producing Thalassery pepper.</p>
   ...
   <h2 style={{width:"350px",marginLeft:"42%",paddingTop:"5px",fontFamily:'math'}}>HISTORY</h2>
   <h4  style={{width:"350px",marginLeft:"37%",paddingTop:"5px",fontFamily:'math'}}>
...
The kingdom of Ezhimala had jurisdiction over two Nadus – The coastal Poozhinadu and the hilly eastern Karkanadu. According to the works of Sangam literature, Poozhinadu consisted much of the coastal belt between Mangalore and Kozhikode.[21] Karkanadu consisted of Wayanad-Gudalur hilly region with parts of Kodagu (Coorg).[22] It is said that Nannan, the most renowned ruler of Ezhimala dynasty, took refuge at Wayanad hills in the 5th century CE when he was lost to Cheras, just before his execution in a battle, according to the Sangam works.[22]</p>
  <h4 style={{width:"350px",marginLeft:"41%",paddingTop:"5px",fontFamily:'math'}}>Early Middle Ages</h4>
  <p>
...
Kannur was an important trading center in the 12th century, with active business connections with Persia and Arabia. The port at Kozhikode held the superior economic and political position in medieval Kerala coast, while Kannur, Kollam, and Kochi, were commercially important secondary ports, where the traders from various parts of the world would gather.[35]
  ...
  <h4  style={{width:"350px",marginLeft:"39%",paddingTop:"5px",fontFamily:'math'}}>Era of European influences</h4>
...
Theyyam season starts from the tenth day of the Malayalam month of Thulam (usually falls during October, and known as paththaam-udayam) and lasts up to seven months till the middle of Edavam month (typically late May and June). The last Kaliyaattam for the season is performed at Madayi Kavu and Kalarivathukkal Bhagavathy Temple, both being the family shrines of Kolathiri royal family.
 ...
 <h4 style={{width:"350px",marginLeft:"42%",paddingTop:"5px",fontFamily:'math'}}>Overview</h4>
...
In Kasaragod and Kannur districts, this ritual art is mainly performed in the kavus (temples) or ancestral houses of Thiyyar, Nambiar, Vaniyar, and Maniyani communities.[4][5]
 ...
 <h4 style={{width:"350px",marginLeft:"42%",paddingTop:"5px",fontFamily:'math'}}>History</h4>
...
<h4 style={{width:"350px",marginLeft:"37%",paddingTop:"5px",fontFamily:'math'}}>Classification of sub-cults</h4>
...
<h4 style={{width:"350px",marginLeft:"42%",paddingTop:"5px",fontFamily:'math'}}>Patronage</h4>
...
<h4 style={{width:"350px",marginLeft:"40%",paddingTop:"5px",fontFamily:'math'}}>Ritual performance</h4>
...
<h3 style={{width:"350px",marginLeft:"39%",paddingTop:"5px",fontFamily:'math'}}>Types of theyyam</h3>
There are about 456 types of theyyam (theyyakkolams), among which 112 are famous. Some of the famous theyyams are:[15]

<h4 style={{width:"350px",marginLeft:"39%",paddingTop:"5px",fontFamily:'math'}}>Kathivanur Veeran</h4>
Main article: Kathivanoor Veeran

<h4 style={{width:"350px",marginLeft:"37%",paddingTop:"5px",fontFamily:'math'}}>Kathivanoor Veeran Theyyam</h4>
The Kathivanur Veeran theyyam is performed in the memory of the great Thiyya community warrior Mandhappan Chekavar.[16][15]

<h4 style={{width:"350px",marginLeft:"39%",paddingTop:"5px",fontFamily:'math'}}>Muchilot Bhagavathi</h4>
...
Muchilot Bhagavathi
<h4 style={{width:"350px",marginLeft:"40%",paddingTop:"5px",fontFamily:'math'}}>Vishnumoorthi</h4>
Main article: Vishnumoorthy Theyyam
...
<h4 style={{width:"350px",marginLeft:"41%",paddingTop:"5px",fontFamily:'math'}}>Muthappan</h4>
Main article: Muthapan
...
<h4 style={{width:"350px",marginLeft:"40%",paddingTop:"5px",fontFamily:'math'}}>Padikutti Amma</h4>
The Padikuttiyamma is believed to be the mother of Muthapan. The Padikutti Amma Theyyam is performed in the Palaprath Temple in Kodallur near Parassini Kadavu in the Meenam (a Malayalam month).[15]

<h4 style={{width:"350px",marginLeft:"43%",paddingTop:"5px",fontFamily:'math'}}>Gulikan</h4>
...
<h4 style={{width:"350px",marginLeft:"37%",paddingTop:"5px",fontFamily:'math'}}>Padamadakki Bhagavathy</h4>
...
<h4 style={{width:"350px",marginLeft:"40%",paddingTop:"5px",fontFamily:'math'}}>Manakkott Amma</h4>
...
<h4 style={{width:"350px",marginLeft:"41%",paddingTop:"5px",fontFamily:'math'}}>Kuttichathan</h4>
Main article: Kuttichathan Theyyam
...
<h4 style={{width:"350px",marginLeft:"41%",paddingTop:"5px",fontFamily:'math'}}>Chamundi</h4>
Chamundi theyyam is majorly of three types, namely Madayil Chamundi,[15] Rakta Chamundi,[15] and Kundorra Chamundi.[15]

<h4 style={{width:"350px",marginLeft:"40%",paddingTop:"5px",fontFamily:'math'}}>Madayil Chamundi</h4>
...
<h4 style={{width:"350px",marginLeft:"41%",paddingTop:"5px",fontFamily:'math'}}>Puthiyaramban</h4>
Puthiyaramban is regarded to have been the greatest warrior of the region called Allada Swaroopam, possessing supernatural power as well as knowledge and skill in kalari (a regional martial art). After a great victory, he is believed to have been betrayed in Nanummel Kali (Kalari). He was posthumously deified. Puthiyaramban Theyyam is performed in Puthiyaramban Tharavadu, Sree Kappattu Kazhagam, Sree Kannamangalam Kazhagam and Udinoor kulom.</p>

</div>
<h1 style={{width:"350px",marginLeft:"39%",paddingTop:"5px",textDecoration:"underline",fontFamily:'math'}}>ROUTE MAP</h1>

<div style={{width:'500px',height:'400px',backgroundColor:'ActiveBorder',marginLeft:"30%"}}>
  <img style={{width:'500px',height:'400px',boxShadow:"1px 1px 20px rgb(202,189,189)"}}  src={img2} alt="" />
</div>
<div width={'100%'} height={'100px'} style={{marginLeft:"42%"}}>
<a href="https://maps.app.goo.gl/Jf6nV4L5LXb2xXw39">click to open map</a>

</div>

   <h1  style={{marginLeft:"35%",textDecoration:"underline",fontFamily:'math'}}>MAJOR ATTRACTIONS</h1>

   <IMG>
   <Link to={'/st.angelos'}><img height={"450px"} width={"400px"}style={{marginTop:"40px",borderRadius:'18px'}} src="https://i.ytimg.com/vi/nMbir7LLfZM/sddefault.jpg" alt="" /> </Link>
   <Link to={'/light'}> <img height={"450px"} width={"400px"}style={{marginTop:"40px",borderRadius:'18px'}} src="https://d2kihw5e8drjh5.cloudfront.net/eyJidWNrZXQiOiJ1dGEtaW1hZ2VzIiwia2V5IjoicGxhY2VfaW1nLzM3NzQ5YzRhZWEzMDQxYjE5Y2UwNTQ2Y2U4ZjJjN2U1IiwiZWRpdHMiOnsicmVzaXplIjp7IndpZHRoIjo2NDAsImhlaWdodCI6NjQwLCJmaXQiOiJpbnNpZGUifSwicm90YXRlIjpudWxsLCJ0b0Zvcm1hdCI6ICJ3ZWJwIn19" alt="" /></Link>
   <Link to={'/muzuppil'}><img height={"450px"} width={"400px"}style={{marginTop:"40px",borderRadius:'18px'}} src="https://upload.wikimedia.org/wikipedia/commons/thumb/d/de/Rocks_at_Muzhappilangad_beach.jpg/1280px-Rocks_at_Muzhappilangad_beach.jpg" alt="" /></Link>
   <Link to={'/payyambalam'}><img height={"450px"} width={"400px"}style={{marginTop:"20px",borderRadius:'18px'}} src="https://www.dtpckannur.com/uploads/picture_gallery/gallery_square/meenkunnu-beach-360x460-20230412193537229220.webp" alt="" /></Link>
   <Link to={'/ezimala'}><img height={"450px"} width={"400px"}style={{marginTop:"20px",borderRadius:'18px'}}  src="https://dynamic-media-cdn.tripadvisor.com/media/photo-o/0e/0a/cc/73/hanuman-statue-ezhimala.jpg?w=600&h=400&s=1" alt="" /></Link>
  <Link to={'/thalassery'}><img  height={"450px"} width={"400px"}style={{marginTop:"20px",borderRadius:'18px'}}  src="https://i.ytimg.com/vi/JtkIABKQgrg/maxresdefault.jpg" alt="" /></Link>
