...
const Kannur = () => {
  return (
    ...
    <div  >
      ...
      <h1  style={{marginLeft:"37%",paddingTop:"5px"}}>ABOUT KANNUR</h1>
...
Kannur Cantonment is the only cantonment board in Kerala.[11] The Indian Naval Academy at Ezhimala is Asia's largest, and the world's third-largest, naval academy.[12][non-primary source needed] Muzhappilangad beach is the longest drive-in beach in Asia and appeared among the top six best beaches for driving in the world in a BBC Top Gear article.[13] During British rule, Kannur's chief importance laid in producing Thalassery pepper.</p>
   ...
   <h2 style={{width:"350px",marginLeft:"42%",paddingTop:"5px"}}>HISTORY</h2>
   <h4  style={{width:"350px",marginLeft:"39%",paddingTop:"5px"}}>
...
The kingdom of Ezhimala had jurisdiction over two Nadus – The coastal Poozhinadu and the hilly eastern Karkanadu. According to the works of Sangam literature, Poozhinadu consisted much of the coastal belt between Mangalore and Kozhikode.[21] Karkanadu consisted of Wayanad-Gudalur hilly region with parts of Kodagu (Coorg).[22] It is said that Nannan, the most renowned ruler of Ezhimala dynasty, took refuge at Wayanad hills in the 5th century CE when he was lost to Cheras, just before his execution in a battle, according to the Sangam works.[22]</p>
  <h4 style={{width:"350px",marginLeft:"41%",paddingTop:"5px"}}>Early Middle Ages</h4>
  <p>
...
Kannur was an important trading center in the 12th century, with active business connections with Persia and Arabia. The port at Kozhikode held the superior economic and political position in medieval Kerala coast, while Kannur, Kollam, and Kochi, were commercially important secondary ports, where the traders from various parts of the world would gather.[35]
  ...
  <h4  style={{width:"350px",marginLeft:"39%",paddingTop:"5px"}}>Era of European influences</h4>
...
Very soon, ideas about socialism and Soviet Revolution reached Kerala. Such ideas got propagated in Kerala through the works of Swadeshabhimani Ramakrishna Pillai, Sahodaran Ayyappan, P. Kesavadev and others. By the beginning of the 1930s, some other useful developments were taking place. Important among them was Nivarthana Agitation in Travancore. That was the demand of people suppressed so far as untouchables and weaker sections for participation in government. This brought to the forefront struggles like proportional representation in government and reservation of jobs. This imparted a new enthusiasm among oppressed masses.[41]</p>
   ...
   <h3 style={{width:"350px",marginLeft:"42%",paddingTop:"5px"}}>Theyyam
...
Theyyam season starts from the tenth day of the Malayalam month of Thulam (usually falls during October, and known as paththaam-udayam) and lasts up to seven months till the middle of Edavam month (typically late May and June). The last Kaliyaattam for the season is performed at Madayi Kavu and Kalarivathukkal Bhagavathy Temple, both being the family shrines of Kolathiri royal family.
 ...
 <h4 style={{width:"350px",marginLeft:"42%",paddingTop:"5px"}}>Overview</h4>
...
In Kasaragod and Kannur districts, this ritual art is mainly performed in the kavus (temples) or ancestral houses of Thiyyar, Nambiar, Vaniyar, and Maniyani communities.[4][5]
 ...
 <h4 style={{width:"350px",marginLeft:"42%",paddingTop:"5px"}}>History</h4>
...
<h4 style={{width:"350px",marginLeft:"39%",paddingTop:"5px"}}>Classification of sub-cults</h4>
...
<h4 style={{width:"350px",marginLeft:"42%",paddingTop:"5px"}}>Patronage</h4>
...
<h4 style={{width:"350px",marginLeft:"40%",paddingTop:"5px"}}>Ritual performance</h4>
...
Muchilot Bhagavathi
<h4 style={{width:"350px",marginLeft:"40%",paddingTop:"5px"}}>Vishnumoorthi</h4>
...
<h4 style={{width:"350px",marginLeft:"41%",paddingTop:"5px"}}>Muthappan</h4>
...
<h4 style={{width:"350px",marginLeft:"40%",paddingTop:"5px"}}>Padikutti Amma</h4>
...
<h4 style={{width:"350px",marginLeft:"42%",paddingTop:"5px"}}>Gulikan</h4>
...
<h4 style={{width:"350px",marginLeft:"39%",paddingTop:"5px"}}>Padamadakki Bhagavathy</h4>
...
<h4 style={{width:"350px",marginLeft:"40%",paddingTop:"5px"}}>Manakkott Amma</h4>
...
<h4 style={{width:"350px",marginLeft:"41%",paddingTop:"5px"}}>Kuttichathan</h4>
...
<h4 style={{width:"350px",marginLeft:"40%",paddingTop:"5px"}}>Madayil Chamundi</h4>
...
<h4 style={{width:"350px",marginLeft:"41%",paddingTop:"5px"}}>Puthiyaramban</h4>
...
<h1 style={{width:"350px",marginLeft:"39%",paddingTop:"5px"}}>ROUTE MAP</h1>
<p style={{marginLeft:"30%"}}>___________________________________________________________</p>

<div style={{width:'500px',height:'400px',backgroundColor:'ActiveBorder',marginLeft:"30%"}}>
  <img style={{width:'500px',height:'400px'}}  src={img2} alt="" />
</div>
<div width={'100%'} height={'100px'} style={{marginLeft:"41%"}}>
<a href="https://maps.app.goo.gl/Jf6nV4L5LXb2xXw39">click to open map</a>

</div>

   <h1  style={{marginLeft:"35%"}}>MAJOR ATTRACTIONS</h1>
   <p style={{marginLeft:"32%"}}>___________________________________________________________</p>
