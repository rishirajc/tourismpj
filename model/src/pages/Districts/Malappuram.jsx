...
import img5 from '../images/malappuram1735300295225.png'
...
const Malappuram = () => {
  ...
  return (
    <div>
     ...
     <div style={{backgroundColor:"#78a9d4",paddingTop:"86px"}}> <h1   style={{marginLeft:"37%",paddingTop:"5px",fontFamily:'math'}}>ABOUT MALAPPURAM</h1>
...
During the colonial era, Malappuram was the headquarters of European and British troops and it later became the headquarters of the Malabar Special Police (M.S.P) formerly known as Malappuram Special Force formed in 1885.[28] The British established the Haigh Barracks on top of the hill of Malappuram, at the bank of the Kadalundi river to station their forces, where once Tipu had a fort. Main Barracks has now been turned into the seat of the district administration as Civil Station, Malappuram.[29][25] Malappuram was the headquarters of one of the five revenue divisions of erstwhile Malabar district, the others being at Thalassery, Kozhikode, Palakkad and Fort Cochin.[30] Apart from the District Board at Calicut, Malappuram Taluk Board were one of the local boards constituted to manage the affairs in Malabar District along with Thalassery, Palakkad and Mananthavady (Wayanad) with jurisdiction corresponding to the divisional charges of the same names.[31] Inscription of the Malappuram Taluk Board can still be seen on the wall of one of the remaining wells constructed in 1916, over 100 years ago at Valiyangadi in the city.[32][33] Offices of the Divisional Revenue Magistrate and Assistant Superintendent of Police of Malabar district were located at Malappuram.[</p>
    <p> <h4   style={{marginLeft:"46%",paddingTop:"5px",fontFamily:'math'}}>Geography</h4>

<h4   style={{marginLeft:"46%",paddingTop:"5px",fontFamily:'math'}}>Topography </h4>
...
<p> 
  <h4   style={{marginLeft:"46%",paddingTop:"5px",fontFamily:'math'}}>Education</h4>
...
<h4   style={{marginLeft:"47%",paddingTop:"5px",fontFamily:'math'}}>Media </h4>
...
<img   style={{marginLeft:"37%",paddingTop:"5px",fontFamily:'math',width:'400px',height:'400px',boxShadow:"1px 1px 20px rgb(202,189,189)"}}  src={img5} alt="" />
...
<IMG>
<Link to={'/bharatha'}> <img height={"450px"} width={"400px"}style={{marginTop:"80px",borderRadius:'18px'}}  src="https://www.shutterstock.com/image-photo/beautiful-view-bharathappuzha-river-kerala-260nw-2317976199.jpg" alt="" /></Link>
<Link to={'/miniooty'}><img height={"450px"} width={"400px"}style={{marginTop:"80px",borderRadius:'18px'}} src="https://i.ytimg.com/vi/khhoIja_Ado/maxresdefault.jpg" alt="" /></Link>
<Link to={'/rainforest'}><img height={"450px"} width={"400px"}style={{marginTop:"80px",borderRadius:'18px'}}  src="https://i.ytimg.com/vi/bQZAM_WlWX8/maxresdefault.jpg" alt="" /></Link>
<Link to={'/keralakund'}><img height={"450px"} width={"400px"}style={{marginTop:"80px",borderRadius:'18px'}}   src="https://cdn.tripuntold.com/media/photos/location/2018/08/12/fd4d40f7-ec12-4e1d-947a-f9a11ce90a32.jpg" alt="" /></Link>
<Link to={'/adayampara'}><img height={"450px"} width={"400px"}style={{marginTop:"80px",borderRadius:'18px'}}   src="https://i.ytimg.com/vi/nHSqbTt5_cw/maxresdefault.jpg" alt="" /></Link>
</IMG>
