...
<h3  style={{backgroundColor:"lightgreen"}}>Climate</h3>
...
<p>
<h4  style={{backgroundColor:"lightgreen"}}>Transportation </h4>
 <h4  style={{backgroundColor:"lightgreen"}}>Airport</h4>
...
<h4  style={{backgroundColor:"lightgreen"}}>Heliport </h4>
...
<h4  style={{backgroundColor:"lightgreen"}}>Road </h4>
...
<p><h4  style={{backgroundColor:"lightgreen"}}>Tourism </h4>
...
<h4  style={{backgroundColor:"lightgreen"}}>Culture zone</h4>
...
<img  style={{width:'500px',height:'400px'}}  src={img12} alt="" />
</div>
