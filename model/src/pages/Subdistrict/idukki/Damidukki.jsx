...
import idu from '/src/pages/Subdistrict/idukki/image/dam.png'
...
const Damidukki = () => {
  return (
    <div>
    <div>
        <img width={"100%"} height={"600px"} src="https://upload.wikimedia.org/wikipedia/commons/thumb/7/77/Idukki_Reservoir_Pano_Calvary_Mount_Kerala_Mar22_A7C_01220-23_Pano.jpg/1920px-Idukki_Reservoir_Pano_Calvary_Mount_Kerala_Mar22_A7C_01220-23_Pano.jpg" alt="" />
    </div>
    <h1 style={{backgroundColor:"lightgreen"}}>About Idukki Dam</h1>
    <p>The Idukki hydroelectric project is the biggest of its kind in the State with an installed capacity of 780 MW. It is one of the highest ten arch dams in the world and the third highest in India after the Tehri Dam (Uttarakhand) and Bhakra Nangal Dam (Himachal Pradesh). 

The Rs. 107.5 crore project, built and managed by the Kerala State Electricity Board (KSEB), was commissioned by the then Prime minister of India, Indira Gandhi in 1976. It took 220 lakh man days to complete the project.</p>
...
Narakakkanam, Azhutha, Vazhikkadavu, Vadakkepuzha and Kuttiar diversion schemes were later added to augment the Idukki reservoir .</p>
    <h2>History</h2>
...
Storage of water in Idukki reservoir commenced in February, 1973. The inauguration of trial run of the first machine was celebrated on 4 October 1975. Commercial operation of the Power Station was Commissioned on 12 February 1976 by the then Prime Minister Smt. Indira Gandhi.[6</p>
<h3>Features</h3>
<p>The Idukki Dam is 168.91 m (554.2 ft) tall, constructed between two mountains, Kuravanmala (839 m (2,753 ft)) and Kurathimala (925 m (3,035 ft)). The length of the dam on its top is 365.85 m (1,200.3 ft). It has a width of 7.62 m (25.0 ft) at the top and 19.81 m (65.0 ft) at the bottom. The gross storage capacity of the dam is 1.996 cubic kms (70.50 tmc ft). About 464,000 m3 (16,400,000 cu ft) of concrete was used in the construction of the dam. This project is situated in Idukki District and its underground power house is located at Moolamattom which is about 43 km (27 mi) from the dam. It is notable that the Idukki arch dam does not have any shutters. The reservoir water level is maintained by the shutters in the Cheruthoni dam.</p>
<h2>Usage</h2>
<p><h3>Power Generation</h3>
Main article: Moolamattom hydro power station
The Project harnesses a major portion of the power potential of Periyar, the largest river in Kerala, by the creation of a reservoir of 2,000 M.cum (2 Billion Tonnes) capacity, diversion of waters thus impounded through a water conductor system consisting of a power tunnel and two underground pressure shafts to an underground power house situated in Moolamattom. The installed capacity of the Power House is 780 MW consisting of 6 Units of Pelton-type turbines with a power generation capacity of 130 MW each. The regulated waters of Periyar falls through a drop of about 669.2 m (2,196 ft) while generating power in the underground power house. The generated power is given to two sub stations. One double circuit line to Kalamassery; one single circuit line to Tamil Nadu; One single circuit line to Pallom, 3 feeder bays for future.</p>
<p> <h3>Irrigation</h3>
The tail waters flowing to Kudayathurpuzha through tunnel and open channel is diverted for irrigation purposes in the Muvattupuzha Valley.</p>
<p> <h3>Tourism</h3>
...
<img width={'200px'} height={'200px'}   src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQ8GhdVYIy6mOzMfSbDfwEXmdNdsjMV3G96bA&s" alt="" />
<img width={'200px'} height={'200px'}   src="https://keralatourism.travel/images/places-to-visit/headers/idukki-dam-timings-entry-fee-bult-by-history-header.jpg" alt="" />
<img width={'200px'} height={'200px'}   src="https://dynamic-media-cdn.tripadvisor.com/media/photo-o/14/d9/5f/05/idukki-dam.jpg?w=1200&h=-1&s=1" alt="" />
<img width={'200px'} height={'200px'}   src="https://upload.wikimedia.org/wikipedia/commons/4/4c/Idukki013.jpg" alt="" />
<img width={'200px'} height={'200px'}   src="https://static.toiimg.com/thumb/65196823.cms?resizemode=75&width=1200&height=900" alt="" />
<img width={'200px'} height={'200px'}   src="https://spicetreemunnar.com/wp-content/uploads/2017/10/idukki-dam-reservoir.jpg" alt="" />
<img width={'200px'} height={'200px'}   src="https://keralabee.com/wp-content/uploads/2023/12/IMG_20231226_221855.jpg" alt="" />
<img width={'200px'} height={'200px'}   src="https://img.onmanorama.com/content/dam/mm/en/kerala/top-news/images/2021/10/22/idukki-dam-new.jpg/photos/16x9/photo.jpg" alt="" />
<img width={'200px'} height={'200px'}   src="https://english.mathrubhumi.com/image/contentid/policy:1.7767812:1659934145/new%20watermark%20outline%20(13)%20(8).jpg?$p=28bf63a&f=16x10&w=856&q=0.8" alt="" />
<img width={'200px'} height={'200px'}   src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRyG8dsh5TTmbjyYME4MhdpG1M6qGfEk3fX4Q&s" alt="" />
<img width={'200px'} height={'200px'}   src="https://i0.wp.com/aravindgundumane.com/wp-content/uploads/2023/01/View-of-Idukki-dam-backwater-from-hill-park.jpg?resize=1140%2C760&ssl=1" alt="" />
<img width={'200px'} height={'200px'}   src="https://i.ytimg.com/vi/OHXwYDKmpgY/hq720.jpg?sqp=-oaymwEhCK4FEIIDSFryq4qpAxMIARUAAAAAGAElAADIQj0AgKJD&rs=AOn4CLC-R1ZaK3wobn4syUnombzAM98c1Q" alt="" />
<img width={'200px'} height={'200px'}   src="https://www.shutterstock.com/image-photo/idukki-dam-hill-view-point-260nw-2367343897.jpg" alt="" />
<img width={'200px'} height={'200px'}   src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQOCn6Czl3EcHkUiBDRD0uKoY9eq9EAqq3YuQ&s" alt="" />
...
<div>
<img  style={{borderRadius:'18px'}} width={"180px"} height={"180px"} src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSU1lC9gPXk9myroA2AEERClvYOv1BijgiJvQ&s" alt="" />
</div>
<a href="https://www.mistywindvalley.in/">click to view</a>
   ...
   <div>
<h3>IGLOO HERITAGE </h3>
<div>
<img  style={{borderRadius:'18px'}} width={"180px"} height={"180px"}  src="https://cf.bstatic.com/xdata/images/hotel/max1024x768/357210040.jpg?k=91c7521e9d2b10b8aba5dc7d59a7cc9384bf9e67e477e26c29cba1d5650aa880&o=&hp=1" alt="" />
</div>
<a href="https://iglooheritageresorts.com/">click to view</a>
</div>


   <div><h3>
  
   Laurel Heights  Idukki</h3>
<div>
<img  style={{borderRadius:'18px'}} width={"180px"} height={"180px"}  src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQI8CQlEESV65Q_9qscgh5yKkZfwn55VM4X4Q&s" alt="" />
</div>
