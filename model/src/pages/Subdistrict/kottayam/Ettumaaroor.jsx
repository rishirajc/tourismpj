...
const Ettumaaroor = () => {
  return (
    <div>
    <div>
        <img width={"100%"} height={"600px"} src="https://www.keralatourism.org/_next/image/?url=http%3A%2F%2F127.0.0.1%2Fktadmin%2Fimg%2Fpages%2Flarge-desktop%2Fezhara-ponnana-1706791953_df57c0fb4818536bc815.webp&w=1920&q=75" alt="" />
    </div>
    <h1 style={{backgroundColor:"lightgreen"}}>About Ettumanoor Mahadevar Temple</h1>
   
   <p>Ettumanoor Mahadeva temple is an ancient Shiva temple in Kottayam, Kerala,[1] India. The temple is one of the major Shiva temples in Kerala, along with Vaikom Temple, Kaduthruthy Mahadeva Temple, Chengannur Mahadeva Temple, Vazhappally Maha Siva Temple, Ernakulam Shiva Temple, Vadakkunathan temple and Sreekanteswaram Mahadeva Temple, Thiruvananthapuram.[2]
...
The name of the place had its mythological origin from the word 'man oor' in Malayalam, which means the place of deer as 'maan' means deer and 'oor' means place. Another version is that the name originated from the 'Ettu Mana Ooru', ie, 'The Land of Eight Namboothiri Manas' or 'Ashta Grihas'. These Eight Manas (Brahmin families) are the original Ooralans of great Ettumanoor Mahadeva Temple. It is also believed that at this place (ooru) Lord Siva appeared in Eight (Ettu) different forms (maanam) and hence the name Ettumanoor.[3] Temple tradition has it that the Pandavas and the sage Vyasa had worshipped at this temple.[</p>
    <p>Ettumanoor Mahadeva temple is an ancient Shiva temple in Kottayam, Kerala, India. Temple tradition has it that the Pandavas and the sage Vyasa had worshipped at this temple. It is believed that at this place [ooru] Lord Siva appeared in Eight [ Ettu] different forms [ maanam] and hence the name Ettumanoor.
...
Temple is administered by Travancore Devaswom Board</p>
<p><h3>Ezhara Ponnana</h3>
...
<h3>Geography</h3>
Ettumanoor Mahadevar Temple is located between Ernakulam district and Kottayam district. It is 54 km from Ernakulam and 12 km from Kottayam.[9] The nearest towns to the temple are Kidangoor, Pala, and Kaduthuruty.</p>
...
<img width={'200px'} height={'200px'}   src="https://upload.wikimedia.org/wikipedia/commons/thumb/5/56/Ettumanoor_Temple_North_Gate_Entrance.JPG/1200px-Ettumanoor_Temple_North_Gate_Entrance.JPG" alt="" />
<img width={'200px'} height={'200px'}   src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQCl_rO62nxk2R6f3qpi-SkP677oFxiY0tWrQ&s" alt="" />
<img width={'200px'} height={'200px'}   src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSDEpl2G3PZVuQjjxiioHX247vv1KE8u8D6Og&s" alt="" />
<img width={'200px'} height={'200px'}   src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcT9oz70-vghve0eiSvTFHugJAAVEnlJeLyavQ&s" alt="" />
<img width={'200px'} height={'200px'}   src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSsA24zn5_O98D8OW-tbOXZj06KcKL06gxL7w&s" alt="" />
<img width={'200px'} height={'200px'}   src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSt35r3p6HlLgDqmYediOBCx7KwfIcSAVds8Q&s" alt="" />
<img width={'200px'} height={'200px'}   src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQIi6ap01x0jXjK3Iz1wbXHrSs4uXxWnFM7iA&s" alt="" />
<img width={'200px'} height={'200px'}   src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSDF-pbqEbav_Xictk6gwgOdZQwI7TuiBqfyg&s" alt="" />
<img width={'200px'} height={'200px'}   src="https://www.keralatourism.org/images/temple/video/thumb/Ettumanoor_Mahadeva_Temple-01012020151819.jpg" alt="" />
<img width={'200px'} height={'200px'}   src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcR4qjdofciHhMZ7iMhMeT0d82YNVgRSDGQIUw&s" alt="" />
<img width={'200px'} height={'200px'}   src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTpJMQR8V_hozczHjLo5rBwhKTsoFPA8EXTjA&s" alt="" />
<img width={'200px'} height={'200px'}   src="https://i.ytimg.com/vi/z08CVv1z47U/sddefault.jpg" alt="" />
<img width={'200px'} height={'200px'}   src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSkpYjT7FajfcQyR6XfQ6StcdwbExr664_dGg&s" alt="" />
<img width={'200px'} height={'200px'}   src="https://www.trawell.in/admin/images/upload/158558585EttumanoorMahadevaTemple_Main.jpg" alt="" />
...
<a href="https://rainforestayur.com/lander">click to view</a>
   ...
   <div>
<h3>Backwater Retreat Theme House
</h3>
<div>
<img  style={{borderRadius:'18px'}} width={"180px"} height={"180px"}  src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRDJBV6mFvTi93qXYCDNgSRLkvO5Mgs7pNLeg&s" alt="" />
</div>
<a href="https://backwaterretreat.in/">click to view</a>
</div>


   <div><h3>
  
   Backwater Heritage Homestay</h3>
<div>
<img  style={{borderRadius:'18px'}} width={"180px"} height={"180px"}  src="https://www.backwaterheritage.com/images/Kumarakom%20Homestay%201.jpg" alt="" />
</div>
<a href="https://www.backwaterheritage.com/">click to view</a>
</div>


   <div><h3>MISTY ROSA RESORTS 
   </h3>
<div>
    <img  style={{borderRadius:'18px'}} width={"180px"} height={"180px"} src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSPMuzl_fXpFrxAMPf775ToSCiWEjJAObqKIw&s" alt="" />
</div>
<a href="https://www.bluepillow.com/search?p_id=589de8b57c00cb10c8d983d8&dest=ago&cat=Vacation%20rental%20(other)&accomodationids=618289009e3163a56a25ad53">click to view</a>
</div>
