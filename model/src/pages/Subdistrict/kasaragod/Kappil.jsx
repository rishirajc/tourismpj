...
<h3 style={{backgroundColor:"lightgreen"}}>Geographic and Demographic Details</h3>
...
According to the 2001 census, Kasaragod had a population of 12, 03342. Males constitute 49% of the population and females 51%. The average literacy rate of Kasaragod is 79%, which is higher than the national average of 59.5%: male literacy is 82%, and female literacy is 76%.</p>
...
The CPCRI has released five coconut hybrids, eight high yielding coconut varieties, five high yielding Areca nut varieties, one Cocoa variety and four Cocoa hybrids to the farming community through its extensive research activities for commercial cultivation.</p>
...
<IMGBOX>
<img width={"200px"} height={"200px"} src="https://www.keralatravelpal.com/images/kappil_beach_near_varkala_kerala.jpg" alt="" />
<img width={"200px"} height={"200px"} src="https://www.trawell.in/admin/images/upload/377739351Kappil_Beach.jpg" alt="" />
<img width={"200px"} height={"200px"} src="https://www.keralabackwater.com/pictures/travel/bekal-beach297_b.jpeg" alt="" />
<img width={"200px"} height={"200px"} src="https://dynamic-media-cdn.tripadvisor.com/media/photo-o/0c/cc/76/5b/img-20160814-wa0174-largejpg.jpg?w=900&h=-1&s=1" alt="" />
<img width={"200px"} height={"200px"} src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSY4v504OFcrix_lWkSGQmQcI6_V0Hh3Ics0g&s" alt="" />
<img width={"200px"} height={"200px"} src="https://www.keralatourism.org/_next/image/?url=http%3A%2F%2F127.0.0.1%2Fktadmin%2Fimg%2Fpages%2Ftablet%2Fkappil-beach-kasaragod-1728481037_640b7601b3f09947b1b2.webp&w=1920&q=75" alt="" />
<img width={"200px"} height={"200px"} src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQipFIfFQ6jmU0fY3cHxRi1lQKzgUdsRrjTGQ&s" alt="" />
<img width={"200px"} height={"200px"} src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTIUBazUX_U0VHh1_h8MOZuEnqrqbHPKoQemQ&s" alt="" />
<img width={"200px"} height={"200px"} src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQePDBhPonwGYrm6pI9XxJzbaDcq-Q1n3u0wQ&s" alt="" />
<img width={"200px"} height={"200px"} src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQ31BIhNTP3nTnGKTU1YZa4v27q-a_fShr3pA&s" alt="" />
<img width={"200px"} height={"200px"} src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRXd9ilhANnMoyYuq_VHOEF9_dZnrUv7-qKVg&s" alt="" />
<img width={"200px"} height={"200px"} src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTWcWz0sU_XC8GLFbkPmr6XZLbGiYQqfFMrQA&s" alt="" />
<img width={"200px"} height={"200px"} src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSJEZ7ypXXIUwYXSvdQTrPmAcjcOgXjY-LVoA&s" alt="" />
<img width={"200px"} height={"200px"} src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRUvkWqx_GGZiG1DTdMOWFb1lUTEbNaOBH27g&s" alt="" />
</IMGBOX>
