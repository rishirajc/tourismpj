...
import alp from '/src/pages/Subdistrict/alapuza/image/chot.png'
...
const Chettikiulangara = () => {
  return (
    <div>
    <div>
        <img width={"100%"} height={"600px"} src="https://www.keralatourism.org/_next/image/?url=http%3A%2F%2F127.0.0.1%2Fktadmin%2Fimg%2Fpages%2Flarge-desktop%2Fchettikulangara-bharani-1706793185_8ef1afdaf5fa281a4eab.webp&w=1920&q=75" alt="" />
    </div>
    <h1 style={{backgroundColor:"lightgreen"}}>About Chettikulangara Devi Temple</h1>
    <p>Chettikulangara Sree Bhagavathi temple is one of the most renowned Hindu temples in Kerala. Main deity is Sree Bhadrakali. The temple is located at Chettikulangara in Mavelikkara taluk of Alappuzha district in the Indian state of Kerala. The temple is situated about 4 kilometres (2.5 miles) west of Mavelikkara town, 7 kilometres (4.3 miles) north of Kayamkulam city on SH6 (Kayamkulam - Thiruvalla Highway). Bhadrakali, is an incarnation of supreme mother Shakthi devi, born from the third eye of Lord Shiva, to kill the demon king Daruka. 'Bhadra' means good and 'Kali' means goddess of time. So Bhadrakali is worshipped for prosperity and salvation. Devi is considered as the creator, protector, destructor, nature, power and Kundalini shakthi. Chettikulangara is located near Kayamkulam city. Chettikulangara is in kayamkulam legislative assembly.</p>
   <p><h3>Overview</h3>
...
As followed for many centuries, elephants are not taken to the western side of the Nalambalam, fearing that the fairy creatures residing at the Chembakam may kill them.</p>
...
The temple will remain closed for the day, and will be opened only the day after. The Aswathy festival concludes the five-month-long festivities at this temple.</p>

<p><h3>Kettukazhcha</h3>
...
All through the way to the temple tender coconut water will be continually poured on his body. After the circumambulation the boys stands at a position facing the Sreekovil (Sanctum Sanctorum) and begins to dance. This ceremony ends with dragging the coil pierced to the skin whereby a few drop of blood comes out.</p>
...
<h2 style={{backgroundColor:"lightgreen"}}>HOW TO REACH:</h2>
   <div style={{width:"100%",height:'300px',display:'flex',alignItems:"center",justifyContent:"space-around",flexWrap:"wrap"}}>
    ...
    Thiruvananthapuram International Airport, about 111 km | Cochin International Airport, about 127 km</p> </div>
    <div style={{width:"380px",height:"250px",backgroundColor:"lightgreen",paddingLeft:"26px"}}> <p><h3>By Train </h3>
    Mavelikkara Railway Station, about 6 km | Kayamkulam Railway Station, about 6 km</p> </div>
    <div style={{width:"380px",height:"250px",backgroundColor:"lightgreen",paddingLeft:"26px"}}> <p> <h3>By Road</h3>
    Mavelikkara Bus Stand, about 5 km</p> </div>
   </div>
...
<img width={'200px'} height={'200px'}   src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSJ22t9dS9t7AemO1sRro78DWFo4J53ta16XA&s" alt="" />
<img width={'200px'} height={'200px'}   src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQBguDCkywqrk4-8ipskvRaHy9IPfODllPIdA&s" alt="" />
<img width={'200px'} height={'200px'}   src="https://dynamic-media-cdn.tripadvisor.com/media/photo-o/06/6b/a9/96/chettaikulanagara-kumbha.jpg?w=1200&h=-1&s=1" alt="" />
<img width={'200px'} height={'200px'}   src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSiRFXBJKLywBGfi7l7tif3LukJg5GW0bMAFg&s" alt="" />
<img width={'200px'} height={'200px'}   src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQDnCnxws_Pt50PRVKTVxLVjYjMGpHTRZXUPg&s" alt="" />
<img width={'200px'} height={'200px'}   src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcR9owqczYXEtFvXnYLZ4H1RvLLnba4mzPBzAg&s" alt="" />
<img width={'200px'} height={'200px'}   src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQkeDC6XQZiHQbgv3XUITD1l0OUeuGOf5wpqg&s" alt="" />
<img width={'200px'} height={'200px'}   src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQghE8SZZTupN9V_fA3qe25gdNWJ2Jl0KpEFw&s" alt="" />
<img width={'200px'} height={'200px'}   src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTwVj_TMzMR_0045d1RLFrqi_iKH_SI6b8RyQ&s" alt="" />
<img width={'200px'} height={'200px'}   src="https://upload.wikimedia.org/wikipedia/commons/thumb/f/f5/Theru.JPG/220px-Theru.JPG" alt="" />
<img width={'200px'} height={'200px'}   src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTS2a5fmQRg42Nz-rYYfDFAjhZW2RoESQPMLQ&s" alt="" />
<img width={'200px'} height={'200px'}   src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRK-hpIIU7XRYelaqzGNjFRH13Lj2pClpEAMQ&s" alt="" />
<img width={'200px'} height={'200px'}   src="https://www.explorebees.com/uploads/Chettikulangara%20Devi%20Temple.jpg" alt="" />
<img width={'200px'} height={'200px'}   src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQgIML1X9yLU3KRVTIcic2bgXYocv8gXTE1WA&s" alt="" />
...
<IMGG>
   ...
   <div><h3>
   MCM Resort & Dormitory</h3>
<div>
<img  style={{borderRadius:'18px'}} width={"180px"} height={"180px"} src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQBpQpPi-8rW7w3mILlbcIwLViDeBELaVq1EA&s" alt="" />
</div>
<a href="https://www.mcmresort.com/">click to view</a>
</div>


   <div>
<h3>Gilead Holliday</h3>
<div>
<img  style={{borderRadius:'18px'}} width={"180px"} height={"180px"}  src="https://cf.bstatic.com/xdata/images/hotel/max1024x768/529038784.jpg?k=e143dc69e21a8e74c88703266da2685a5af76dd8a0103c2c4bdf07e14dfe0aed&o=&hp=1" alt="" />
</div>
<a href="https://www.bluepillow.com/search?p_id=589de7f07c00cb10c8d9752e&dest=bkng&cat=Villa&accomodationids=65ca8ab6671b07d23c6de564">click to view</a>
</div>


   <div><h3>
  
   Mavalikara City Staycation</h3>
<div>
<img  style={{borderRadius:'18px'}} width={"180px"} height={"180px"}  src="https://cf.bstatic.com/xdata/images/hotel/max1024x768/536401716.jpg?k=5349aa8622a6e65c8da393a999a75739530ed8c626f91551b8198463a471020a&o=&hp=1" alt="" />
</div>
<a href="https://www.booking.com/hotel/in/mavalikara-city-staycation.en-gb.html?aid=2068758&label=seogooglelocal-link-imagesaow-hotel-11714787_grp-3_gendate-20240917&sid=4d1f5003b68185b5abb429c67ab5ab2f&dist=0&keep_landing=1&sb_price_type=total&type=total&utm_campaign=en&utm_medium=description&utm_source=seogooglelocal&utm_term=hotel-11714787&">click to view</a>
</div>


   <div><h3>Sreelakshmi Residency</h3>
<div>
    <img  style={{borderRadius:'18px'}} width={"180px"} height={"180px"} src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSSE_P0smFt_9MzZyufoy4lnwtiFzGJAlQB6Q&s" alt="" />
</div>
<a href="https://www.sreelakshmiresidency.com/">click to view</a>
</div>
...
export default Chettikiulangara
