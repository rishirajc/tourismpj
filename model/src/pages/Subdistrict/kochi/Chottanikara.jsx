...
import bol from '/src/pages/Subdistrict/kochi/image/chotani.png'
...
In terms of temple architecture, the Chottanikkara temple stands out to be an ultimate testimonial to the ancient transl. hi – transl. vishwakarma sthapathis (wooden sculpture) along with Sabarimala temple.

The temple is also known for conducting exorcism.[3]People suffering from mental illnesses and commonly visit the temple, as Chottanikkara Devi is said to cure her devotees. Guruthi pooja is a ritual done in the late evening to invoke the goddess Mahakali. Earlier 'Guruthi Pooja' was done only on Fridays. But nowadays, it is performed every day.</p>
<p> <h3>Legend</h3>
...
Tuesday and Friday are important dates for Bhagavathy temples. You can see heavy rush on these days.</p>
...
<img width={'200px'} height={'200px'}   src="https://upload.wikimedia.org/wikipedia/commons/a/ae/Chottanikkara_Temple.jpg" alt="" />
<img width={'200px'} height={'200px'}   src="https://www.keralatourism.org/images/temple/video/thumb/Chottanikkara_Bhagavathy_Temple,_Ernakulam-02012020163526.jpg" alt="" />
<img width={'200px'} height={'200px'}   src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSxQy_VYwj-RQFw-Wk6nSGk-KL7Fdw6R0Pz9A&s" alt="" />
<img width={'200px'} height={'200px'}   src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcR50MbYvaE-UFvZQuPjJq1CijdeYg_Is9dmFA&s" alt="" />
<img width={'200px'} height={'200px'}   src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRsCtY-XaOyQ-rRObE29o45gk2gT_mbyIMPAA&s" alt="" />
<img width={'200px'} height={'200px'}   src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRZa4Y42eB2_mtpsyY3P5ECKtYPdCVRng2nXA&s" alt="" />
<img width={'200px'} height={'200px'}   src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTgoyoUUZE7nBLLGLlX7qTyG6cQUagnbKRbDg&s" alt="" />
<img width={'200px'} height={'200px'}   src="https://blog.yatradham.org/wp-content/uploads/2021/03/Chottanikkara-Temple.jpg" alt="" />
<img width={'200px'} height={'200px'}   src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcS-zZdM0MrQu8qhdmnExUmEr9_JrZdG8Bx7YQ&s" alt="" />
<img width={'200px'} height={'200px'}   src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRIWsCdvhhjSLtB6D8cJef-2kLZ5UUMMZ_FdQ&s" alt="" />
<img width={'200px'} height={'200px'}   src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcS-T3Z9I3KqTWiH_5yRKx-GDqFzrokr18Dfbw&s" alt="" />
<img width={'200px'} height={'200px'}   src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQIQgO3Du2SiU0bGFSrQN5HnOEzeWKm4udiiA&s" alt="" />
<img width={'200px'} height={'200px'}   src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQ3tfrpVtMAzBnPoNZcuklLZnaY84FBDYd4cQ&s" alt="" />
<img width={'200px'} height={'200px'}   src="https://bluebirdtravels.in/wp-content/uploads/temples/kochi-ernakulam/shiveli-chottanikkara-temple-599x350.jpg" alt="" />
</IMGBOX>
...
<IMGG>
   ...
   <div><h3>
   vrindavan residency </h3>
<div>
<img  style={{borderRadius:'18px'}} width={"180px"} height={"180px"} src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQERdCM8c0pY5mwmdMW6f5cQwNHtt02O7RqiQ&s" alt="" />
</div>
<a href="https://www.makemytrip.com/hotels/vrindavan_residency-details-cochin.html">click to view</a>
</div>


   <div>
<h3>Ashoka Inn Chottanikkara</h3>
<div>
<img  style={{borderRadius:'18px'}} width={"180px"} height={"180px"}  src="https://cf.bstatic.com/xdata/images/hotel/max1024x768/209194893.jpg?k=fc5e9c39746bbfcf6b021fea3bc2d9637432e21be9452a5a338ecb6c81d1e49f&o=&hp=1" alt="" />
</div>
<a href="https://www.chottanikkarahotels.com/">click to view</a>
</div>
   ...
   NM Royale County</h3>
<div>
<img  style={{borderRadius:'18px'}} width={"180px"} height={"180px"}  src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRLv031dsGLnXza-SLEPg5FQsQoSa0YJirO4A&s" alt="" />
</div>
<a href="https://www.nmroyalecounty.com/">click to view</a>
</div>


   <div><h3>The Wyte Fort</h3>
<div>
    <img  style={{borderRadius:'18px'}} width={"180px"} height={"180px"} src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSTj_doc2yDtAS3lEYuYwLsWW5Zn8ZNp9-pXA&s" alt="" />
</div>
<a href="https://www.makemytrip.com/hotels/the_wyte_fort-details-cochin.html">click to view</a>
</div>
