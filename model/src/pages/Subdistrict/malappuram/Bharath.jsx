...
const Bharath= () => {
  return (
    <div>
    <div>
        <img width={"100%"} height={"600px"} src="https://i.pinimg.com/originals/25/91/4e/25914e04ed3100fc93dd512ea372b168.jpg" alt="" />
    </div>
    <h1 style={{backgroundColor:"lightgreen"}}>About Bharathappuzha</h1>
   <p>The Bharathappuzha ("River of Bhārata"), also known as the Nila or Ponnani River,[3] is a river in the Indian states of Tamil Nadu and Kerala. With a length of 209 km,[1] it is the second longest river that flows through Kerala after the Periyar.[4] It flows through Palakkad Gap, which is also the largest opening in the Kerala portion of Western Ghats.[5] The Nila has groomed the culture and life of South Malabar part of Kerala. It is also referred to as the "Peraar" in ancient scripts and documents. River Bharathapuzha is an interstate river and lifeline water source for a population residing in four administrative districts, namely Malappuram and Palakkad districts, and parts of Palakkad-Thrissur district border of Kerala and Coimbatore, and Tiruppur of Tamil Nadu. The fertile Thrissur-Ponnani Kole Wetlands lie on its bank.</p>
<h3>Etymology</h3>
<p>The river originates in Tamil Nadu, Thirumoorthy Dam. Once it enters Kerala, it gets significance and has five names - Bharathappuzha, Ponnani River, Nila, Perar, and Kuttippuram River, of which the first name is more popular. The river meets the Lakshadweep Sea at an 'azhi' (estuary), the southern part of which is known as Ponnani and northern part as Padinjarekkara. Thus the river gets the name Ponnani River.[3] After the construction of the famous Kuttippuram bridge over Bharathappuzha to connect Kozhikode with Kochi, the name Kuttippuram River also became familiar.</p>
<h3>Course</h3>
<p>The headwaters of the main tributary of Bharathapuzha originates from various parts of the Western Ghats near the Anamailai hill ranges in Tamil Nadu as small rivulets, and flows westward through Palakkad Gap, (also known as Palghat gap) across Palakkad and Malappuram districts of Kerala, with many tributaries joining it, including the Tirur River. For the first 40  km or so, the Bharathappuzha follows an almost northerly course till Pollachi near Coimbatore. At Parli, the Kannadipuzha and Kalpathipuzha River merge and flow as Bharathappuzha, following a westerly course until it empties into the Lakshadweep Sea at Ponnani.[2] At Mayannur, Gayathripuzha merges with the river. The Thuthapuzha merges with the Nila at Pallippuram. As the Thootha River is rich in water, after its merger, the Nila becomes thicker inflow.
...
Friends of Bharathapuzha, a nature lovers' collective, is being formed with the objective of strengthening and protecting the Bharathapuzha. It is led by E.M. Sreedharan, veteran engineer popularly known as 'Metroman'.</p>
<h3>Actions required for saving the river</h3>
<p>Environmentalists suggest the followings actions for saving the river.[citation needed]
...
Constructing check dams: Check dams slow down the flow of the river where by recharging the ground water and increasing the water table.</p>
<h3>Tributaries</h3>
<p>Two main branches meet at Kuttipuram and flow to the Arabian Sea. Each in turn has several branches as shown in the diagram. List of the tributaries sorted in order from the mouth heading upstream.
...
<IMGBOX>
<img width={'200px'} height={'200px'}  src="https://img.onmanorama.com/content/dam/mm/en/news/kerala/images/2019/10/22/bharathapuzha-river-kerala.jpg?crop=fc&w=575&h=575" alt="" />
<img width={'200px'} height={'200px'}  src="https://pd.w.org/2023/06/641649314a826deb3.18815720-300x225.jpeg" alt="" />
<img width={'200px'} height={'200px'}  src="https://kerala.me/wp-content/uploads/2015/12/Bharathapuzha.jpg" alt="" />
<img width={'200px'} height={'200px'}  src="https://upload.wikimedia.org/wikipedia/commons/thumb/7/7c/Bharathapuzha_River.png/300px-Bharathapuzha_River.png" alt="" />
<img width={'200px'} height={'200px'}  src="https://avathioutdoors.gumlet.io/travelGuide/dev/malappuram_P7498.jpg" alt="" />
<img width={'200px'} height={'200px'}  src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRFpJIj06rAYNI5IYhQq-GLqDPb5Y66ZUtl9g&s" alt="" />
<img width={'200px'} height={'200px'}  src="https://cdn.malabarnews.com/wp-content/uploads/2021/02/29195812/bharathappuzha.jpg" alt="" />
<img width={'200px'} height={'200px'}  src="https://upload.wikimedia.org/wikipedia/commons/thumb/5/57/GKN_Chamravattom_Regulator_Bridge_DSC_0446.JPG/640px-GKN_Chamravattom_Regulator_Bridge_DSC_0446.JPG" alt="" />
<img width={'200px'} height={'200px'}  src="https://img-mm.manoramaonline.com/content/dam/mm/mo/district-news/malappuram/images/2024/6/21/malappuram-bharathappuzha.jpg" alt="" />
<img width={'200px'} height={'200px'}  src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcS6jxVopv8_XkLn7Hy_59DNRdelFNRauBi9Hg&s" alt="" />
<img width={'200px'} height={'200px'}  src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSa_1S2yvw3Lca13S6Thh7JgyJI1zPhYTYaHQ&s" alt="" />
<img width={'200px'} height={'200px'}  src="https://content3.jdmagicbox.com/comp/pollachi/v3/9999p4259.4259.221127034417.a4v3/catalogue/bharathappuzha-river-pollachi-tourist-attraction-0heiwp9niq.jpg" alt="" />
<img width={'200px'} height={'200px'}  src="https://i.ytimg.com/vi/5BYHevMGUF4/maxresdefault.jpg" alt="" />
<img width={'200px'} height={'200px'}  src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSnVNsIpedYBoih67DauSJw-N7pU3bn12PK6w&s" alt="" />
</IMGBOX>
...
<div><h3>Emarald Resort</h3>
<div>
<img  style={{borderRadius:'18px'}} width={"180px"} height={"180px"} src="https://dynamic-media-cdn.tripadvisor.com/media/photo-o/04/62/1d/c3/emarald-ayurvedic-resort.jpg?w=700&h=-1&s=1" alt="" />
</div>
<a href="https://emaraldresort.com/">click to view</a>
</div>


   <div>
<h3>Coco Lagoon by Great Mount </h3>
<div>
<img  style={{borderRadius:'18px'}} width={"180px"} height={"180px"}  src="https://pix10.agoda.net/hotelImages/484779/-1/544769b121ed75b37a987db303db5d70.jpg?ca=9&ce=1&s=414x232" alt="" />
</div>
<a href="https://www.greatmount.in/">click to view</a>
</div>
...
<div>
<img  style={{borderRadius:'18px'}} width={"180px"} height={"180px"}  src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQfa3zNCPnBEOcsl5oTtrE8r2lmsKk7tIVkeg&s" alt="" />
</div>
<a href="https://www.themangocounty.in/?utm_source=google&utm_medium=wix_google_business_profile&utm_campaign=7483131292507865942">click to view</a>
   ...
   <div><h3>Sakthi River Resorts</h3>
<div>
    <img  style={{borderRadius:'18px'}} width={"180px"} height={"180px"} src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQdmp1tM6Yzmv1FN9ttowkdbQCpeIoLeuQeqQ&s" alt="" />
</div>
<a href="https://sakthiresorts.com/">click to view</a>
</div>
